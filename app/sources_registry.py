...
SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "editorial_note": "12 units spanning major argument arcs (death-practice, recollection, affinity, harmony, second sailing, immortality, suicide/guardianship, cyclical generation, true virtue/mysteries, misology, true-earth myth, final composure). Jowett PD English; Pratibha layers editorial.",
        "license": "public_domain",
        "sell_ready_tier": "green",
        "pd_alternative": None,
        "status": "in_corpus",
    ...
    },
    {
        ...
        "editorial_note": "Pilot: 12 units — Genjōkōan (7) and Uji (5) from Kokubasha 1896 PD Japanese. Pratibha English/commentary editorial. Bendōwa still pending.",
        "license": "mixed",
        "sell_ready_tier": "green",
        "pd_alternative": None,
        "status": "in_corpus",
    },
    {
        ...
        "editorial_note": "Pilot: 12 units from *Von Abegescheidenheit* in corpus. MHG from Quint DW 5 (eckhart.de); Pfeiffer 1857 PD OCR in data/raw_texts. Pratibha English, commentary, and resonances are editorial. *Von Armûot des Geistes* still pending.",
        "license": "public_domain",
        "sell_ready_tier": "green",
        "pd_alternative": None,
        "status": "in_corpus",
    ...
    },
    {
        ...
        "editorial_note": "Pilot: 22 units — Ney-nāmeh (8), Moses & shepherd (4), elephant in the dark (3), Chinese/Greek painters (3), merchant's parrot (2), die before you die (2). Persian from Ganjoor/masnavi.net; Pratibha English strong_draft / UNVERIFIED pending Persian review.",
        "license": "mixed",
        "sell_ready_tier": "yellow",
        "pd_alternative": None,
        "status": "in_corpus",
    },
    {
        ...
        "editorial_note": "14 songs/hymns: Ch. X solitude cycle (13) plus Ch. XII illness-as-adornment hymn. Evans-Wentz/Dawa-Samdup PD English; Pratibha translation and commentary editorial. Snow Song and Six-Bardo songs appear only as references in Ch. XI of this edition.",
        "license": "public_domain",
        "sell_ready_tier": "green",
        "pd_alternative": None,
        "status": "in_corpus",
