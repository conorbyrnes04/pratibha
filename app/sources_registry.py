...
SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "editorial_note": "22 units — Ney-nāmeh, Moses & shepherd, elephant in the dark, the painters, the merchant's parrot, die-before-you-die. English rendered independently from the Persian (the modern rendering does not follow any copyrighted translation); romanized transliteration and book/story source reference added per unit; commentary editorial.",
        "license": "public_domain",
        "provenance_tier": "pd_render",
        "status": "in_corpus",
    },
