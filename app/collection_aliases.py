...
COLLECTION_ALIASES: dict[str, set[str]] = {
    ...
    "gospel_of_thomas": {"gospel_of_thomas", "thomas"},
    "gospel_of_mary": {
        "gospel_of_mary",
        "gospel_of_mary_magdalene",
        "mary_gospel",
        "gospel_according_to_mary",
    },
    "new_testament_logia": {
        "new_testament_logia",
        "logia_of_jesus",
        "mystical_logia_of_jesus",
        "nt_logia",
        "sayings_of_jesus",
    },
    "zhongyong": {"zhongyong", "doctrine_of_the_mean"},
    "vajracchedika_diamond_sutra": {
        "vajracchedika_diamond_sutra",
        "vajracchedikā_prajñāpāramitā",
