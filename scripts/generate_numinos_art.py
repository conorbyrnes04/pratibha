...
MANIFEST: list[dict[str, str]] = [
    {"slug": "os_africanos_no_brasil", "match": r"africanos.?no.?brasil|os_africanos", "subject": "Afro-Brazilian Bahia — not a generic jeweled wheel, not a lotus, not an Asian pagoda — four nation-boats at a tropical harbor (Nagô Jeje Angola Malê), an open Arabic Qur'an on a wooden desk beside a Portuguese book, Friday white cloth and prayer beads, a Bahian butcher-shop wall, tall drums before a whitewashed terreiro, a whip broken on the ground, concentric nation-names ringing the harbor"},
    {"slug": "animismo_fetichista", "match": r"animismo|fetichista|gantois|animisme", "subject": "Afro-Bahian Candomblé — not an Asian pagoda — a whitewashed terreiro pavilion of torchis and tile on a steep Bahian hill, the windowless peji lit by one oil lamp, Sango's thunder-stone on an earthen plate, Yemanja's sea-stone and small offering boats on dark water, a vast iroko fig-tree bleeding sap, cowrie shells cast on a table, drums and possession at Gantois"},
    {"slug": "myths_of_ife", "match": r"myths.?of.?i[fẹf]e|wyndham|aramfe|oduduwa", "subject": "Ìfẹ̀ cosmogony — Arámfè sending sons from Heaven, a five-clawed bird scattering magic sand upon the sea, Odudúwa's stolen bag of arts sinking as stone, a vulture with fire on its bald head, Olókun curbing the hungry waves, Ógun walking into his own forest, concentric priest-recitation ringing the sacred city as the world's first homestead"},
