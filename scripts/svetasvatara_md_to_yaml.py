#!/usr/bin/env python3
"""
Parse Pratibha markdown source for Svetasvatara Upanishad into YAML units.

Usage:
  python scripts/svetasvatara_md_to_yaml.py <input_md> <output_dir>
"""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Convert Svetasvatara markdown to YAML files.")
    ...
    for rec in records:
        ...
        out = args.output_dir / f"svetasvatara_{idx}.yml"
        out.write_text(
