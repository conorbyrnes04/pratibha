...
MANIFEST: list[dict[str, str]] = [
    ...
    {"slug": "zeus", "subject": "a forked thunderbolt, three zigzag lightning tines, no person"},
    ...
    {"slug": "apollo", "subject": "a seven-string lyre with curved arms, no person"},
    {"slug": "artemis", "subject": "a hunting bow with a crescent moon above it, no person"},
    ...
    {"slug": "kali", "subject": "a curved ritual sickle-sword over a ring of skulls, no person, no face"},
    ...
    {"slug": "ganesha", "subject": "an elephant head in profile with one broken tusk, ink brush, no human body"},
    ...
    {"slug": "anubis", "subject": "a jackal head in profile, long pricked ears, ink brush, no human body"},
