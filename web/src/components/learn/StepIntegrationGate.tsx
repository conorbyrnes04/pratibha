...
export function StepIntegrationGate({
  ...
  const recallOk = !keyIdea || revealed;
  ...
  return (
    <div className="max-w-[var(--reading-measure)] border-t border-emerald-300/25 pt-4">
        ...
        <div className="mt-4 space-y-3">
          ...
          {!revealed ? (
            ...
            <div className="rounded-xl border border-amber-200/20 bg-amber-200/5 px-3 py-3">
              <p className="font-sans text-[10px] uppercase tracking-[0.14em] text-amber-200/70">Key idea</p>
              <p className="mt-1 text-sm leading-relaxed text-stone-100">{keyIdea}</p>
              {recall.trim() ? (
      ...
      <Button type="button" onClick={onComplete} disabled={!ready || !recallOk} className="mt-4">
