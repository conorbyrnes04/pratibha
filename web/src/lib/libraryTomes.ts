...
const TOME_META: TomeMeta[] = [
  ...
  { pattern: /lalla|lal.?ded|lalleshwari|vakyani|vākyāni/i, tradition: "Kashmir Śaiva", author: "Lal Ded (Lalleshwari)", authored: "c. 14th c. CE", eraYear: 1370 },
  ...
  { pattern: /gospel.?of.?mary/i, tradition: "Christian", author: "Anonymous (BG 8502)", authored: "c. 2nd c. CE", eraYear: 150 },
  { pattern: /logia of jesus|new.?testament.?logia/i, tradition: "Christian", author: "Jesus (canonical gospels)", authored: "1st c. CE", eraYear: 30 },
  ...
  { pattern: /senegalese.?animism|serer|lasnet|pangool/i, tradition: "Serer", author: "Oral (Serer)", authored: "recorded 1879–1900 CE", eraYear: 1900 },
  { pattern: /pulaar.?texts|gaden|le.?poular/i, tradition: "Pulaar", author: "Futa Toro literates", authored: "recorded 1913 CE", eraYear: 1913 },
  { pattern: /futa.?jalon|fuuta.?jaloo|reichardt/i, tradition: "Futa Jalon", author: "Futa Jalon literates", authored: "recorded 1876 CE", eraYear: 1876 },
  { pattern: /pulaar.?tradition|ful[bɓ]e|peul/i, tradition: "Pulaar", author: "Oral (Fulɓe)", authored: "recorded 1883–1900 CE", eraYear: 1900 },
  { pattern: /africanos.?no.?brasil|os_africanos/i, tradition: "Candomblé", author: "Nina Rodrigues (observer)", authored: "written c. 1905, pub. 1932 CE", eraYear: 1932 },
  { pattern: /animismo|fetichista|gantois|animisme/i, tradition: "Candomblé", author: "Nina Rodrigues (observer)", authored: "1896–1900 CE", eraYear: 1900 },
  { pattern: /candombl/i, tradition: "Candomblé", author: "Nina Rodrigues (observer)", authored: "1896–1932 CE", eraYear: 1900 },
  { pattern: /myths.?of.?[iìí]|myths_of_ife|wyndham|aramfe/i, tradition: "Yoruba", author: "Oral (Ìfẹ̀ priests)", authored: "recorded 1921 CE", eraYear: 1921 },
